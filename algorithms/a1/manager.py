...
"""
Скрипт переделать.
Логирование и обновление баланса вынесено в другие функции.
Здесь должен быть реализрован алгоритм и выставлен ордер в зависимости от результата.
Балан будет изменен после выставления ордера.
При вычислении в алогритме надо смотреть в active_orders и history_tik, current_price
"""
